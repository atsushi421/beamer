...
\newcommand{\summary}[0]{
    \begin{frame}{}
        \vspace{3mm}
        \centering
        \hspace{3mm}\includegraphics[scale=0.44]{one_page_summary.jpg}
    \end{frame}
}
...
\newcommand{\fitimage}[2]{%
    ...
    #1\par
    \centering
    \hspace{5.0mm}\fbox{\includegraphics[width=\textwidth,height=\fitimageht,keepaspectratio]{#2}}
}
% Simplification
\newcommand{\assume}[1]{
