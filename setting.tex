...
\newcommand{\slide}[2]{\begin{frame}{#1}\begin{textblock*}{0.1\linewidth}(-3pt, 236pt)\includegraphics[scale=0.5]{C:/Users/atsushi/Documents/workspace/env/Beamer/beamer/beamer/master_figure/Emb_logo.pdf}\end{textblock*}#2\end{frame}}
