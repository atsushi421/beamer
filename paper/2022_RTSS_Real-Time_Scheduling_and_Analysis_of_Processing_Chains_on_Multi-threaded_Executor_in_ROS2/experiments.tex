...
\begin{frame}{パフォーマンス比較方法}
    \vspace{1mm}
    \begin{block}{OUR-1}
        \hlink{theorem3}{Theorem 3}, \hlink{theorem1}{Theorem 1} によって実行されるスケジュール可能性テスト
    \end{block}
    \begin{block}{OUR-2}
        \hlink{theorem3}{Theorem 3}, \hlink{theorem2}{Theorem 2} によって実行されるスケジュール可能性テスト
    \end{block}
    \begin{block}{SIMU}
...
\begin{frame}{ケーススタディの概要}
    \fitimage{
        \begin{itemize}
            ...
            \item これらは Choiら~\cite{choi2021picas}が現実的な自律走行システムから開発したサブチェーンを引用
        \end{itemize}
...
\begin{frame}{実験方法}
    \begin{itemize}
        ...
        \item \hlink{theorem2}{Theorem 2} により各チェーンの応答時間境界を計算し, 観測された下限と比較する
    \end{itemize}
\end{frame}
...
\begin{frame}{ケーススタディ1による実験結果}
    \fitimage{
        \begin{itemize}
            ...
            \item マルチスレッドエグゼキュータでスケジューリングされた各チェインの応答時間はシングルスレッドエグゼキュータよりはるかに小さいことがわかる
