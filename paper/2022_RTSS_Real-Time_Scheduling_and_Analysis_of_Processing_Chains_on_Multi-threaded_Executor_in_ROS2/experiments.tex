...
\begin{frame}{評価指標}
    \begin{itemize}
        \item パフォーマンスは\al{受入}で評価する
        \item 受入: スケジュール可能なタスクシステムの数とタスクシステム全体の数の比率
        \item 各図の $y$ 軸は受入を示す
    \end{itemize}
\end{frame}

\begin{frame}{異なる $U_{\text {norm }}$ における受入}
    \fullimage{figure/exp_random_u.png}
\end{frame}

\begin{frame}{異なる $n$ における受入}
    \fullimage{figure/exp_random_n.png}
\end{frame}

\begin{frame}{異なる $b$ における受入}
    \fullimage{figure/exp_random_b.png}
\end{frame}
...
\begin{frame}{異なる $\alpha$ における受入}
    \fullimage{figure/exp_random_alpha.png}
\end{frame}

\begin{frame}{異なるスレッド数 $m$ における受入}
    \fullimage{figure/exp_random_m.png}
\end{frame}
...
\begin{frame}{ケーススタディの概要}
    \fitimage{
        ...
        \end{itemize}
    }{figure/exp_case_study_desc.png}
...
\begin{frame}{観測された問題の例}
    \fitimage{
        ...
        \end{itemize}
    }{figure/exp_problem_ex.png}
\end{frame}

\begin{frame}{観測された問題の例補足}
    \fullimage{figure/exp_problem_ex_sup.jpg}
\end{frame}
