...
\begin{frame}{処理チェーン}
    \fitimage{
        \begin{itemize}
            ...
            \item 各ソースは, 1 つまたは複数のコールバックチェーン $\gamma^{x}=\left(c_{s}, \ldots, c_{e}\right)$ を生成する
...
\begin{frame}{アクティベーションモデル}
    \begin{itemize}
        \item 各ソースコールバック $c_{s}$ は, アクティベーション曲線 $\eta_{s}^{e}(\Delta)$ \cite{henia2005system, leboudec2001theory, thiele2000real}に関連付けられている
